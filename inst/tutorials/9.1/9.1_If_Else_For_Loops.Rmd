...
author: 
- "Zachary Binney, PhD"
- "Modifed by Charis Wiltshire, MPH"
date: "March 2026"
...
Let's have a little fun to introduce if-else statements. Say you want R to offer you some sort of greeting when you start a script, but that greeting should depend on the time of day: "Good Morning!", "Good Afternoon!", "Good Evening!", or "Go To Sleep, Bestie" 
...
if (between(hr, 5, 11) & name == "Charis") { # Check if it's between 5am and 11am
  
  print("Good Morning, Charis!")
