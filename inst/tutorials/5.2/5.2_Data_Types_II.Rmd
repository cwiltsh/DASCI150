...
At this point you might be thinking, "OK, we've seen vectors and lists, but they don't look anything like the **data frames** and **tibbles** we've been working with. I'm so confused." Data frames and tibbles are really just vectors and lists under the hood. 
...
bday <- as.Date("1996-08-04")
  ...
  unclass(bday) # I was born 9,712 days after January 1, 1970
```

And here's how R stores my birth time (shout out Pisces rising):

```{r datetime, exercise = TRUE}
# My birthdate and time
bday <- ymd_hms("1996-08-04 10:45:00 AM") #ymd_hms tells R we're giving it data in the order Year, Month, Day, Hours, Minutes, Seconds
  ...
  #Here's how we print its underlying numeric value
  unclass(bday) # I was born 839,155,500 seconds after midnight on January 1, 1970
```
