...
```
Not great! Now it tries to plot and connect all the points at each longitude within each state first, rather than drawing state borders in the proper `order`.

<mark>Challenge:</mark> Can you figure out how to modify the code above to undo our horrible mistake of re-sorting the data *without* deleting the current `arrange()`.
